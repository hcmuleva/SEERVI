...
const TopicDialog = (props) => {
  console.log("PROPS IN TOPIC DIALOG ",props)
  console.log("CREATE TOPIC DATA DIaLOG from TopicDialog", props.subjectid);
  ...
  const handleAdd = (event) => {
   console.log("FORM DATA ",formObject)
    createTopic({
      ...
      refetchQueries: [{ query: GET_UNIT_BY_ID, variables: { id: props.unitid} }],
    })
      .then((res) => {

...
export default function YouTubeOptionDialog(props) {
  ...
  const handleAdd = (event) => {
    const newElm = {
      optionurl: textDataType,
      optionDataType: "YOUTUBE",
      optionfileInfo: "",
      optionData: "",
  ...
  return (
    <div>
      ...
      >
        <DialogContent>
          <DialogContentText>"Option Create YOU TUBE URL "</DialogContentText>
          <TextField
            autoFocus
            margin="dense"
            label="Enter Option URL"
            type="text"
            fullWidth
            value={textDataType}
            onChange={(event) => {

...
import { CREATE_FORMULA } from "../../../../../../graphql/mutations/education/formula";
...
export default function FormulaCreator(props) {
  const classes = useStyles();
  console.log("FORMULA CREATION PROPERTY", props);
                  ...
                  if (contentType === "HTML") {
                    ...
                    uploadFile(file).then((res) => {
                      ...
                      createFormula({
                        ...
                        .then((res) => {
                          console.log("MYOBJECTCreated Formula", res);
                          resetObect();
                        })
                        .catch((err) => {
                          throw new Error("Error in creating Formula");
                        });
                    });
                  } else {
                    createFormula({

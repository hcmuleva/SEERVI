...
import { CREATE_TIPSTRICKS } from "../../../../../../graphql/mutations/education/tipstrick";
...
export default function TipsTrickCreator(props) {
  const classes = useStyles();
  console.log("EXAMPLE CREATION PROPERTY", props);
  ...
  const [createTipsTrick] = useMutation(CREATE_TIPSTRICKS);
  const resetObect = () => {
    setName("");
    setEditorContent("");
    setUrl("");
                  ...
                  if (contentType === "HTML") {
                    ...
                    uploadFile(file).then((res) => {
                      ...
                      createTipsTrick({
                        ...
                        .then((res) => {
                          console.log("MYOBJECTCreated TipsTrick", res);
                          resetObect();
                        })
                        .catch((err) => {
                          throw new Error("Error in creating TipsTrick");
                        });
                    });
                  } else {
                    createTipsTrick({

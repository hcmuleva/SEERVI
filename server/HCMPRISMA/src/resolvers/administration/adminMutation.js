...
import {createRole,updateRole,deleteRole,assignRoleToUser,assignRoleToUsers} from './mutation/Role'
...
export const AdminMutation = {
    ...
    createRole,updateRole,deleteRole,assignRoleToUser,assignRoleToUsers,

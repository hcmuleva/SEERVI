...
import {allroles,myRoles,orgRoles,suborgRoles,groupRoles,subGroupRoles,roleById} from './query/roles'
export const AdminQueryFunction={
    ...
    allroles,myRoles,orgRoles,suborgRoles,groupRoles,subGroupRoles,roleById
